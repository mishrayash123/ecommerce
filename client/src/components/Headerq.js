  ...
  return (
    <div className="absolute top-[0px] left-[0px] bg-sandybrown w-[1728px] h-[89px] overflow-hidden text-left text-xl text-black font-made-tommy">
      ...
      <img
        ...
        alt=""
        src="/codiconaccount1q.svg"
      />
      <div className="absolute top-[calc(50%_-_25.5px)] left-[calc(50%_+_6px)] rounded-3xl bg-palegoldenrod w-[334px] h-[51px] overflow-hidden text-base text-gray-200 font-inter">
        <img
      ...
      <div className="absolute top-[-1px] left-[-95px] shadow-[1px_7px_11.4px_rgba(0,_0,_0,_0.25)] rounded-t-none rounded-br-51xl rounded-bl-none bg-salmon w-[909px] h-[90px] overflow-hidden text-5xl text-white">
        ...
        <img
          className="absolute top-[calc(50%_-_23px)] left-[335px] max-w-full overflow-hidden h-[47px]"
          alt=""
          src="/vector-3q.svg"
        />
        <img
          className="absolute top-[calc(50%_-_23px)] left-[552px] max-w-full overflow-hidden h-[47px]"
          alt=""
          src="/vector-3q.svg"
        />
        <img
          className="absolute top-[calc(50%_-_23px)] left-[688px] max-w-full overflow-hidden h-[47px]"
          alt=""
          src="/vector-3q.svg"
        />
      </div>
      <div className="absolute top-[22px] left-[1588px] rounded-20xl bg-salmon w-5 h-5 overflow-hidden text-xs text-white font-inter">
        <div className="absolute top-[calc(50%_-_7px)] left-[calc(50%_-_3px)] font-extrabold">
          1
        </div>
      </div>
    </div>
