  ...
  return (
    <div className="bg-sandybrown flex md:justify-between h-[89px] overflow-hidden text-xl text-black font-made-tommy">
      ...
      >
        ...
        <div className=" top-[30px] left-[155px] flex flex-row items-start justify-start gap-[5px] text-center relative">
        ...
        <div className="absolute top-[30px] left-[705px] flex flex-row items-center justify-start gap-[5px] text-center ">
          ...
          {isAccessoriesDropdownOpen && (
            <div className="absolute top-[40px] left-0 bg-white text-black w-[200px] shadow-md rounded-md">
