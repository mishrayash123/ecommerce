  ...
  return (
    <div className="absolute top-[50px] left-[70px] shadow-[0px_286px_80px_rgba(0,_0,_0,_0),_0px_183px_73px_rgba(0,_0,_0,_0.01),_0px_103px_62px_rgba(0,_0,_0,_0.05),_0px_46px_46px_rgba(0,_0,_0,_0.09),_0px_11px_25px_rgba(0,_0,_0,_0.1)] rounded-7xl bg-darkslategray-400 w-[406px] h-[739px] overflow-hidden text-left text-5xl text-white font-made-tommy">
      ...
      <img
        ...
        src="/vector-144q.svg"
      />
      <div className="absolute top-[171px] left-[72px] font-medium">
        Today’s Sales
      </div>
      <img
        className="absolute top-[215px] left-[45.5px] rounded-12xs w-[11.5px] h-4 object-contain"
        alt=""
        src="/vector-144q.svg"
      />
      <div className="absolute top-[208px] left-[71px] font-medium">
        Today’s Order
      </div>
      <img
        className="absolute top-[258px] left-[45.5px] rounded-12xs w-[11.5px] h-4 object-contain"
        alt=""
        src="/vector-144q.svg"
      />
      <div className="absolute top-[251px] left-[71px] font-medium">
        Today’s Visitors
      </div>
      <div className="absolute top-[294px] left-[45.5px] rounded-6xs bg-gray-800 flex flex-row items-center justify-start py-0 px-3 gap-[14px]">
        <img
          className="w-[11.5px] relative rounded-12xs h-4 object-contain"
          alt=""
          src="/vector-29q.svg"
        />
        <div className="relative font-medium">Today’s Clients</div>
      </div>
      <FrameComponent18
