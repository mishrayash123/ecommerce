const HeaderTop = () => {
  return (
    <div className="absolute top-[0px] left-[0px] bg-sandybrown w-[1728px] h-[89px] overflow-hidden text-left text-xl text-black font-made-tommy">
      ...
      <div className="absolute top-[-1px] left-[-95px] shadow-[1px_7px_11.4px_rgba(0,_0,_0,_0.25)] rounded-t-none rounded-br-51xl rounded-bl-none bg-salmon-100 w-[909px] h-[90px] overflow-hidden text-5xl text-white">
      ...
      <img
        className="absolute top-[67px] left-[1510px] max-h-full w-[27.5px]"
        alt=""
        src="/vector-7.svg"
      />
    </div>
