...
const FrameComponent16 = () => {
  return (
    <div className="absolute top-[50px] left-[70px] shadow-[0px_286px_80px_rgba(0,_0,_0,_0),_0px_183px_73px_rgba(0,_0,_0,_0.01),_0px_103px_62px_rgba(0,_0,_0,_0.05),_0px_46px_46px_rgba(0,_0,_0,_0.09),_0px_11px_25px_rgba(0,_0,_0,_0.1)] rounded-7xl bg-darkslategray-400 w-[406px] h-[961px] overflow-hidden text-left text-base text-white font-made-tommy">
      ...
      <FrameComponent19 />
      <div className="absolute top-[441px] left-[45.5px] rounded-10xs bg-gray-800 flex flex-row items-center justify-start py-0 px-3 gap-[14px] text-5xl">
        <img
  ...
  <a href="/dashboard5" style={{ textDecoration: 'none' }}>Add Product</a>
      ...
      <img
        className="absolute top-[calc(50%_+_11.5px)] right-[349px] rounded-12xs w-[11.5px] h-4 object-contain"
        alt=""
        src="/vector-144q.svg"
      />
      <img
