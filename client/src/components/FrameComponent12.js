const FrameComponent12 = () => {
  return (
    <div className="absolute top-[0px] left-[0px] rounded-t-xl rounded-br-120xl rounded-bl-xl bg-bisque w-[348px] h-[552px] overflow-hidden text-left text-base text-dimgray-600 font-inter">
      <img
      ...
      <img
        ...
        src="/vector-13.svg"
      />
      <div className="absolute top-[498px] left-[15px] font-semibold">₹899</div>
      ...
      <img
        className="absolute top-[calc(50%_-_211px)] left-[calc(50%_-_150px)] w-[301px] h-[242px] object-cover"
        alt=""
        src="/image-42@2x.png"
      />
    </div>
