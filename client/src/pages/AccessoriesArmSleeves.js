...
//             <div className="md:p-4 bg-salmon-100 rounded-bl-11xl p-1  ">Socks</div>
//           </Link>
//           <Link to="/accessories-hanky" className=" p-1 md:p-4 bg-salmon-100 no-underline text-white">
//             <div>Hanky </div>
//           </Link>
//           <Link to="/accessories-arm-sleeves" className=" p-1 md:p-4 rounded-br-11xl bg-yellow-400 no-underline text-white">
//             <div>Arm sleeves</div>
//           </Link>
//         </div>
//       </div>
...
//               <span className="relative">All ArmSleeves</span>
//               <img
...
//           <div>
//             <FrameComponent5
//               overSizedTShirt="Over Sized ArmSleeves"
//               allTShirt="All ArmSleeves"
//               menFullSleeveTShirts="Men Full ArmSleeves"
//               hoodedTShirts="stylish ArmSleeves"
//               jackets="ArmSleeves"
//               dropCutTShirts="short ArmSleeves"
//               easyFitFullSleeveTShirt="Easy Fit ArmSleeves"
//             />
//           </div>
//           <div className='mb-3'>
//             <FrameComponent3 />
...
//           {products.filter((e)=>(e.category==="AccessoriesArmSleeves")).map((product) => (
//             <a
//               key={product._id}
//               href=''
...
// export default AccessoriesArmSleeves;

// AccessoriesArmSleeves.jsx
...
const AccessoriesArmSleeves = () => {
  ...
  const filterProductsByPriceRange = (products) => {
    ...
    return products.filter((product) => {
      ...
      // Check if the price is already a number or a string
      if (typeof product.price === "number") {
        price = product.price;
      } else if (typeof product.price === "string") {
        price = Number(product.price.replace(/Rs\.|,/g, ""));
      } else {
        // If product.price is not a number or a string, return false for this product
        return false;
      }
