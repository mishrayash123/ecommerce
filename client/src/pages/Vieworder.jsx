...
<div className="w-1/2 mx-auto rounded-11xl bg-blue-700 flex flex-row items-center justify-center py-2.5 px-8 cursor-pointer my-3" onClick={()=>{
       nav('/updateorder', { state: {orderid:orders._id} });
    }}>
      <div className="relative text-white font-semibold">Update</div>
    </div>
          ))}
