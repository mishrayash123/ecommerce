    ...
    <div className=" bg-white text-dimgray-600 font-poppins">
      ...
      <div className="relative">
        ...
        <div className="absolute top-0 right-0 flex rounded-t-none justify-between flex-row w-auto   lg:text-9xl  md:font-bold text-white md:text-4xl text-sm  font-made-tommy ">
          <Link to="/undergarments-men-women1" className="no-underline text-white">
            <div className="md:p-4   bg-salmon-100 rounded-bl-11xl p-1  ">MEN</div>
          </Link>
          <Link to="/undergarments-men-women" className=" p-1 md:p-4   bg-yellow-400 rounded-br-11xl no-underline text-white">
            <div>WOMEN </div>
          </Link>
        </div>
        ...
        <div className='flex items-end flex-col'>
          ...
          <div className=" flex  justify-between flex-col md:flex-row">
            ...
            <div className=" rounded-10xl flex flex-row items-center justify-center py-0.5 px-[18px] gap-[10px] text-dimgray-300 border-[1px] border-solid border-darkgray-100">
              <span className="relative">All Undergarments</span>
              <img
      ...
      <div className='flex flex-col md:flex-row'>
        ...
        <div className='flex md:w-[30%] flex-col'>
          ...
          <div>
            <FrameComponent5
              overSizedTShirt="Over Sized undergarments"
              allTShirt="All undergarments"
              menFullSleeveTShirts="Women Full undergarments"
              hoodedTShirts="stylish undergarments"
              jackets="undergarments"
              dropCutTShirts="short undergarments"
              easyFitFullSleeveTShirt="Easy Fit undergarments"
            />
          </div>
