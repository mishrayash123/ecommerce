...
//       <img
//         className="absolute top-[89px] left-[-132px] w-[2294px] h-[588px] object-cover"
//         alt=""
//         src="/image-15@2x.png"
//       />
...
//         <div className="relative">Men Pants</div>
//         <img
...
//       </div>
//       <FrameComponent5
//         overSizedTShirt="Men Joggers"
//         allTShirt="Men Pants"
//         menFullSleeveTShirts="Men Parachute Pants"
//         hoodedTShirts="Textured Pants"
//         jackets="Men Jeans"
//         dropCutTShirts="Men Cargo Pants"
//         easyFitFullSleeveTShirt="Men Bermuda Pants"
//       />
//       <FrameComponent4 propTop="1856px" propHeight="371px" />
//       <FrameComponent7
//         prop="28"
//         prop1="36"
//         prop2="30"
...
<MainHeader
      ...
      <div className='flex flex-col md:flex-row'>
        ...
        <div className='flex md:w-[30%] flex-col'>
          ...
          <div>
            <FrameComponent5
              overSizedTShirt="Over Sized  Lower"
              allTShirt="All  Lower"
              menFullSleeveTShirts="Men's  Lower"
              hoodedTShirts="readymade Lower"
              jackets="short  Lower"
              dropCutTShirts=" Lower"
              easyFitFullSleeveTShirt="Easy Fit Full  Lower"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:w-[72%] mx-auto sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 justify-center mb-5 md:gap-10 lg:gap-9 ">
          {products.filter((e)=>(e.category==="ReadymadeLower")).map((product) => (
            <a
              key={product._id}
              href=''
